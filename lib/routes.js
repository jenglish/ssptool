...
/** Query function: find Page
 *  _note_ matched against route /pages/*, tail of path is params[0].
 */
function findPage (db, params) {
    var page = db.pages.findByKey(params[0]);
    if (page) {
        return { page: page };
    } else {
        throw notfound('page', params[0]);
    }
}
