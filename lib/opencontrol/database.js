...
class Database {
     ...
     * If page.data has a 'satisfies' property,
    ...
    addPage (page) {
        ...
        if (page.data.satisfies) {
            ...
            let implementation_status = page.data.implementation_status;
            let name = page.data.title;
            ...
            this.components.add({
                ...
                references: [{
                    name: name,
                    path: '/pages/' + page.relative // @see linkto.page
                }]
            });
